...
public class WorldSettings
{
  ...
  public ValueBooleanList addBooleanList(String name, ArrayList<Boolean> valueList) {
    String txt = name + "=";
    for (Iterator<Boolean> localIterator = valueList.iterator(); localIterator.hasNext(); ) { boolean val = ((Boolean)localIterator.next()).booleanValue();
  ...
  public ValueFloatList addFloatList(String name, ArrayList<Float> valueList) {
    String txt = name + "=";
    for (Iterator<Float> localIterator = valueList.iterator(); localIterator.hasNext(); ) { float val = ((Float)localIterator.next()).floatValue();
  ...
  public ValueIntegerList addIntegerList(String name, ArrayList<Integer> valueList) {
    String txt = name + "=";
    for (Iterator<Integer> localIterator = valueList.iterator(); localIterator.hasNext(); ) { int val = ((Integer)localIterator.next()).intValue();
